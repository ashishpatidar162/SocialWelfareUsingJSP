...
<head>
	...
	<title>Social Welfare Donation</title>
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Donation</a></h1>
		<form id="form_27981" class="appnitro"  method="post" action="fooddonateaction.jsp">
			...
			<ul >
			<li id="li_2" >
		<label class="description" for="element_2">Choose The Catagory Of Food</label>
		<span>
...
<div>
                     <button type="submit" name="submit" class="btn btn-block btn-primary" >Donate</button>
</div>
			</ul>
		</form>	
