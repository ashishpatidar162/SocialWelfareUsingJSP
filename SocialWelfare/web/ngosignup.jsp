...
<div class="body-content">
  <div class="module">
    <h1>NGO Account</h1>
    <form   action="ngoregaction.jsp" method="post" onsubmit="return checkvalidation();">
      <div class="alert alert-error"></div>
     <input type="text" name="parkname"  placeholder="Ngo Name" pattern=".{5,15}" required>
     <input type="email" name="username" placeholder="user@domain.com" pattern=".{3,100}" required>
     <input type="password" id="password" name="password" placeholder="Password" pattern=".{5,10}" required>
     <input type="password" id="repassword" name="password"   placeholder="Re-enter Password" pattern=".{5,10}" required>
     <input type="text" name="reg" placeholder="Reg No."  pattern=".{4,10}" required >
                                                       
     <input type="text" name="city" id="Email"  placeholder="City" pattern=".{3,100}" required>
                                                    
                                      
                  <div>
                                                <select id="s" name="ps" onchange="loaddistrict(this.value)" tabindex="5" > 
                                                    <option value="select">choose state</option>
                                                   <%
                                                      String sql1 = "select * from state";
                                                   //    out.print("Record not found......");
                                                       ResultSet cats1 = DB.connect.getData(sql1);
                                                       while (cats1.next()) {
                                                    %>
                                                    <option value="<%=cats1.getString("stateid")%>" ><%=cats1.getString("statename")%> </option>
                                                    <%
                                                        }
                                                    %>  
                                                </select>

                                                <select  name="pd"  id="district"  tabindex="5" > 
                                                ...
                                                <div><br>
                                                    ...
                                                    <div >
                                                        <input type="text" name="parkaddress" id="Email"  placeholder="Ngo address" pattern=".{3,100}" required>
                                                    </div>
                                                    <div >
                                                        <input type="text" name="contactp" id="Email"  placeholder="Contact Person" pattern=".{3,100}" required>
                                                    </div>
                                                    <div >
                                                        <input type="text" name="contactnumber" id="Email"  placeholder="Contact Number"  pattern=".{10,12}"required>
                                                    </div>
                                                ...
                                                <div >
                                                  ...
                                                  <script type="text/javascript">
                                                    function instShow() {
                                                        ...
                                                        document.getElementById("iad").style.visibility = "visible";
                                                    ...
                                                    function instHide() {
                                                        ...
                                                        document.getElementById("iad").style.visibility = "hidden";
                    ...
                    <script type="text/javascript">
                        function loaddistrict(state) {
                            ...
                            obj = (window.XMLHttpRequest) ? new XMLHttpRequest() : ((window.ActiveXObject) ? new ActiveXObject("MicroSoft.XMLHTTP") : null);
                            if (obj !== null) {
                                ...
                                obj.open('get', 'getdistrict.jsp?s=' + state, true);
    ...
    {
//        alert("hello");
        var pwd = document.getElementById("password").value;//$("#password").val();
        var repwd = document.getElementById("repassword").value;//$("#repassword").val();
//        alert(pwd+" == "+repwd);
        if(pwd != repwd)
        {
            document.getElementById("password").classList.add("valcls");//$("#password").addClass("valcls");
            document.getElementById("repassword").classList.add("valcls");//$("#repassword").addClass("valcls");
            return false;
        }else{
            
        $("#password").removeClass("valcls");
            $("#repassword").removeClass("valcls");
            return true;
        }
    }
</script>
