...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Donation</a></h1>
		<form id="form_27981" class="appnitro"  method="post" action="ngoclothaction.jsp">
					<div class="form_description">
			<h2>Clothes Request</h2>
			<p></p>
		</div>						
			<ul >
			
		</li>		<li id="li_1" >
		<label class="description" for="element_1">Request Clothes Per Person </label>
		<div>
