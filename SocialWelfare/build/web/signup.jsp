...
<div class="body-content">
  <div class="module">
    <h1>User Account</h1>
    <form  action="signupaction.jsp" method="post" onsubmit="return checkvalidation();">
      <div class="alert alert-error"></div>
      
                    <input id="name" name="firstname" placeholder="First Name" required="" tabindex="1" type="text" pattern=".{3,15}"> 
                    
                    <input id="name"  name="lastname" placeholder="Last Name" required="" tabindex="1" type="text" pattern=".{3,15}" >
                    ...
                    <input type="password" id="repassword" name="password" placeholder="RE-ENTER PASSWORD" required=""> 


                    <select class="select-style gender" name="gender">
                        <option value="ns">i am..</option>
                    ...
                    <input id="phone" name="phone" placeholder="MOBILE NUMBER" required="" type="text" pattern=".{10,12}"> <br>
                    <p>
...
<!--<div  class="form">
                <form id="contactform" action="userregction.jsp" method="post" > 
                    ...
                    <p>
                        <label>User Type*</label></p>
                    <p>

                        <br>
                        <INPUT TYPE="Radio" Name="utype" Value="ind" onclick="instHide()"><label>Individual</label>

                        <INPUT TYPE="Radio" Name="utype" Value="inst" onclick="instShow()"><label>Institution</label>

                        <input id="iname" name="iname" placeholder="Institution Name"  style="visibility:hidden;" tabindex="1" type="text"></p>
                    <p><input id="iad" name="iad" placeholder="Institution Address"  style="visibility:hidden;" tabindex="1" type="text"></p>
                    <input id="is" name="is" placeholder="state"  style="visibility:hidden;" tabindex="1" type="text"> 
                    <input id="ic" name="ic" placeholder="Office Contact"  style="visibility:hidden;" tabindex="1" type="text">



                    <br>
                    <input type="submit" class="buttom" name="submit" id="submit" tabindex="5" value="Sign me up!" > 	
                    <a href="login.jsp" class="btn btn-label btn-social btn-facebook mb-md"><i class="ti ti-facebook"></i>Already Registered ? Click Here to Login !</a>
