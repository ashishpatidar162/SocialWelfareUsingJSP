...
<html lang="en">
  <head>
      <style>
          body{
              ...
              background: #FFFFFF url("images/home-bg.jpg");
          }  
          </style>
    <meta charset="utf-8" />
    <title>THANKS</title>
  ...
  <body>
    <!-- Header -->
      <p style="margin-left:1200px;margin-top:80px;font-size:20px;color: white"> <a href="index.jsp" class="section-btn pricing-btn"><b><u>Logout</b></u></a> </p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <h2>Your Donation is Successfull  !</h2>
            <p>FASTEST WAY TO FIND YOUR NGO</p>
          </div>
        </div>
      </div>
    ...
    <section>
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <a href="index.jsp"><div class="btn btn-action">Back To Home</div></a>
          </div>
        </div>
      </div>
    </section>
