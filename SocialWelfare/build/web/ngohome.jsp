          ...
          <div class="container">
               ...
               <div class="navbar-header">
                    <button class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                     ...
                     <!--lOGO TEXT HERE--> 
                    <a href="index.html" class="navbar-brand"><b><%= ulevel%></b></a>
               </div>
                 <!--MENU LINKS--> 
              <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                     ...
                     <ul class="nav navbar-nav navbar-right">
                       ...
                       <p> <a href="javascript:void(0);" class="section-btn pricing-btn">Request</a> </p>
                    </ul>
               </div>
...
<h1 align=center> Request Category</h1>
